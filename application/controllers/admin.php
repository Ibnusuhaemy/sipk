...
class Admin extends CI_Controller{
    ...
    public function admin_edit_jadwal(){
        ...
        $t['data_kelas'] = $this->content_data->query_kelas();
        $t['data_program'] = $this->content_data->query_program();
    ...
    public function pengumuman(){
        ...
        $t['mn']	= "admin/admin_pengumuman";
        $this->load->view('admin/home', $t);
    }
    
    public function tambah_pengumuman(){
        $t['mn']	= "admin/tambah_pengumuman";
        $this->load->view('admin/home', $t);
    }
    
    public function insert_pengumuman(){
        $this->load->model('content_admin','content_data');	
        $this->content_data->insert_pengumuman();	
    ...
    public function edit_pengumuman(){
        ...
        $this->load->model('content_admin','content_data');
        $t['dt']	= $this->content_data->edit_pengumuman($id);
        $t['mn'] 	= "admin/edit_pengumuman";
        $this->load->view('admin/home',$t);
    }
    
    public function act_edit_pengumuman(){
        $this->load->model('content_admin','content_data');
        $this->content_data->query_edit_pengumuman();
        header('location:pengumuman');
    }
    ...
    public function hapus_pengumuman(){
        $id = $this->uri->segment(3);	
        $this->load->model('content_admin','content_data');
        $this->content_data->hapus_data_pengumuman($id);
